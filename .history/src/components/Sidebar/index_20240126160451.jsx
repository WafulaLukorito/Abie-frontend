...
const Sidebar = () => {
  ...
  return (
    <div>
          {/* Sidebar */}
          <div className={`sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[200px] overflow-y-auto text-center ${isSidebarOpen ? 'bg-purple-700' : 'hidden'}`}>
        {/* Toggle button inside sidebar when open */}
        {isSidebarOpen && (
          <span
            className="absolute text-black text-4xl top-5 right-4 cursor-pointer z-50"
...
{!isSidebarOpen && (
  <span
    className="sidebar absolute text-white text-4xl top-5 left-4 cursor-pointer z-20"
    onClick={toggleSidebar}
  >
    {">>"}
  </span>
