...
const Sidebar = () => {
  ...
  return (
    <div>
         {/* Sidebar */}
      <div className={`sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[200px] overflow-y-auto text-right ${isSidebarOpen ? 'bg-purple-700' : 'hidden'} --tw-gradient-from: bg-purple-700`}>
