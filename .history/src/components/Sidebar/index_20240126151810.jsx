...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-blue-600 ${isSidebarOpen ? '' : 'hidden'}`}>
      ...
      >
        <i className="bi bi-filter-left px-2 bg-magenta-900 rounded-md"></i>
      </span>
      <div className="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-#7200F5">
        {/* Search bar */}
