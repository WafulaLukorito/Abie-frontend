...
const Sidebar = () => {
  ...
  return (
    <div>
         {/* Sidebar */}
      <div className={`sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[200px] overflow-y-auto text-right ${isSidebarOpen ? 'bg-purple-700' : 'hidden'} bg-gradient-to-t `}>
        
        {/* Toggle button inside sidebar when open */}
        {isSidebarOpen && (
          <span
            className="text-white text-4xl cursor-pointer z-50 top-0"
