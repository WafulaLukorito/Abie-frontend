...
const Sidebar = () => {
  ...
  return (
    <div>
         {/* Sidebar */}
      <div className={`sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[200px] overflow-y-auto text-right ${isSidebarOpen ? 'bg-purple-700' : 'hidden'}`}>
      ...
      {/* My ABIE link */}
      <div className=" flex items-center button-style mt-3 cursor-pointer hover:bg-blue-500 text-white rounded-full py-2 px-4">
