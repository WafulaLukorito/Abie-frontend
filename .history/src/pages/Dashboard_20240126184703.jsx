                ...
                <div className="container mx-auto px-6 py-8">
                 <table className="min-w-full leading-normal">
                        ...
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <span className={`h-4 w-4 inline-block rounded-full ${item.color === 'red' ? 'bg-red-500' : item.color === 'green' ? 'bg-green-500' : 'bg-blue-500'}`} />
                        </td>
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm bg-green-500 rounded-full">{item.color}</td>
